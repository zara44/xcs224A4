...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[
        ...
        enc_hiddens_packed, last_tuple = self.encoder(X_packed)
        last_hidden = last_tuple[0]
        last_cell = last_tuple[1]
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        combined_outputs = torch.stack(tuple(combined_outputs), dim=0)
        ### END YOUR CODE
